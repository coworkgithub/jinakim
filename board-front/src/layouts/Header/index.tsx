...
const onLogoClickHandler = ()=>{
    navigate(MAIN_PATH()); //클릭시 메인페스로 이동
} 
...
const onSeachWordKeyDownHandler= (event: KeyboardEvent<HTMLInputElement>) =>{
if(event.key !=='Enter') return;
if(!searchButtonRef.current) return;
searchButtonRef.current?.click(); 
};
        
    //              event handler: 검색 버튼 아이콘 클릭 이벤트 처리함수//
    ...
    //검색 버튼 컴포넌트 랜더링(클릭 true)-버튼을 누르면 나타남 //
return(
    <div className='header-serch-input-box'>
      <input className='header-search-input' type='text' placeholder='검색어를 입력해 주세요' value={word} onChange={onSearchWordChangeHandler} onKeyDown={onSeachWordKeyDownHandler} />
    ...
    <div id = 'header'>
        <div className='header-container'>
            <div className='header-left-box' onClick={onLogoClickHandler}> 
                ...
                <div className='header-logo'>{'reve'}</div>
            </div>
